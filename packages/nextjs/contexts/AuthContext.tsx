...
import { useScaffoldReadContract, useScaffoldEventHistory, useScaffoldWatchContractEvent } from "@/hooks/scaffold-eth";
...
export default function AuthContextProvider({ children }: { children: React.ReactNode }) {
  ...
  const { data: isRegistered, refetch: refetchIsRegistered } = useScaffoldReadContract({
